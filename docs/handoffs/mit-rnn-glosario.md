# Glosario: MIT 6.S191 (2020) Lecture 2 -- RNNs
...
**Backpropagation Through Time (BPTT)** - Generalizacion del algoritmo de backpropagation aplicada al grafo computacional desplegado de una RNN. La pena se acumula sobre todos los pasos temporales y los gradientes se propagan hacia atras a traves de la cadena recurrente.
