...
{{< cards >}}
  ...
  {{< card link="/laboratorios/lab-42" title="Laboratorio 42" subtitle="El práctico: YOLO26 + BoT-SORT y YOLO-World + SAM 2 sobre cinco videos. El ID switch rastreado hasta una caja duplicada con IoU 0,976, la re-identificación que no puede participar por su compuerta de proximidad, y submuestrear a 15 fps que mejora el seguimiento" icon="beaker" >}}
