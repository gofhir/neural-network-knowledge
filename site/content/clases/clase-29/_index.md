...
{{< cards >}}
  ...
  {{< card link="/laboratorios/lab-29" title="Laboratorio: Stable Diffusion con diffusers" subtitle="Manipular SDXL/SD1.5: pasos, schedulers, guidance, Img2Img, Inpainting, ControlNet + cuestionario (trilemma, difusión latente)" icon="photograph" >}}
