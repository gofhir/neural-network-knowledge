...
{{< cards >}}
  ...
  {{< card link="/laboratorios/lab-39" title="Laboratorio 39" subtitle="La familia M sobre la onda cruda de UrbanSound8K y fine-tuning de VGGish: el campo receptivo medido capa a capa, y cuatro defectos del pipeline que invierten conclusiones" icon="variable" >}}
