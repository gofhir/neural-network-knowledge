...
{{< cards >}}
  ...
  {{< card link="/clases/clase-39" title="Clase siguiente de audio: Modelos de DL para Audio" subtitle="Qué modelo va encima del espectrograma: CNN+RNN+MLP, onda cruda y convoluciones dilatadas" icon="arrow-right" >}}
