...
{{< cards >}}
  ...
  {{< card link="/laboratorios/lab-31" title="Laboratorio: DQN sobre CartPole" subtitle="Tutorial aplicado con Gymnasium: DQN resuelve CartPole en 85 episodios + 4 ablations propias (velocidades/replay/target/hiperparámetros)" icon="variable" >}}
