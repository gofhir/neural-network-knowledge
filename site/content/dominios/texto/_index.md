...
{{< timeline >}}
  ...
  {{< era name="Era de la atención" years="2017-2020" >}}
    ...
    {{< /hito >}}
    {{< hito year="2018" name="ELMo" status="deep" link="/fundamentos/embeddings-contextualizados" >}}
      Deep Contextualized Word Representations (Peters et al., NAACL 2018 Best Paper). Char-CNN + 2 BiLSTM con forward y backward LMs entrenados conjuntamente, combinación lineal task-specific. **Por qué importó:** introdujo *embeddings contextuales* — el vector de cada palabra depende de su oración. Mejoró SOTA en SQuAD, SNLI, SRL, Coref, NER, SST-5. Ver también [paper](/papers/elmo-peters-2018).
    {{< /hito >}}
    ...
    {{< /hito >}}
    {{< hito year="2019" name="BETO" status="covered" link="/fundamentos/bert" >}}
  ...
  {{< era name="Era de los LLMs" years="2020-presente" >}}
    ...
    {{< /hito >}}
    {{< hito year="2021" name="BERTIN" status="covered" link="/fundamentos/bert" >}}
      Proyecto comunitario (BERTIN Project + Flax + Google TPU Research Cloud) que entrenó BERT en español sobre mC4-es con distintas estrategias de muestreo (gaussian, stepwise, random). **Por qué importó:** demostró que la comunidad open-source puede producir modelos competitivos sin compute industrial. Modelos en `bertin-project/*` en Hugging Face.
    {{< /hito >}}
